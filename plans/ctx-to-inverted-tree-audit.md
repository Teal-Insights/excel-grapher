...
| Unions / `SUM` of a range | yes | `xl_sum` / `xl_sumproduct` of covering series (`take` for a window) | **port shipped** ([#667](https://github.com/Teal-Insights/excel-grapher/issues/667)). `SUM(IF(…))` of aligned covering series shipped ([#732](https://github.com/Teal-Insights/excel-grapher/issues/732)); unsound alignment stays fail-closed. |
...
| Array formulas / spill (#284), `SUMPRODUCT`, `SUM(IF(…))` (#732) | yes / partial | `SUMPRODUCT` of covering series; aligned `SUM(IF)` of covering series; spill fail closed | **port** mechanical `SUMPRODUCT` shipped ([#667](https://github.com/Teal-Insights/excel-grapher/issues/667)); aligned `SUM(IF)` shipped ([#732](https://github.com/Teal-Insights/excel-grapher/issues/732)); spill remains [#284](https://github.com/Teal-Insights/excel-grapher/issues/284). |
