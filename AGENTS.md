...
- CLI smoke check: `uv run excel-grapher bindings validate tests/fixtures/inverted_tree/tiny_dsa/tiny-dsa.xlsx --bindings tests/fixtures/inverted_tree/tiny_dsa/bindings --smoke-test`