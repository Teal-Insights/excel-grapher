...
Examples::
    ...
    uv run python examples/lic_dsf/report_chart_shock_sensitivity.py \\
        --workbook examples/lic_dsf/data/lic-dsf-template-2025-08-12.xlsm

    uv run python examples/lic_dsf/report_chart_shock_sensitivity.py \\
        --workbook examples/lic_dsf/data/dsf-uga.xlsm \\
