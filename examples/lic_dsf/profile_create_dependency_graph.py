...
Run from the repository root::
    ...
    uv run python examples/lic_dsf/profile_create_dependency_graph.py \\
        --cprofile-out /tmp/lic_graph.prof --cprofile-print 40

Smaller / faster iteration (shallow closure, few targets)::

    uv run python examples/lic_dsf/profile_create_dependency_graph.py --max-targets 30 --max-depth 12 \\
...
from examples.lic_dsf import extract_graph_uncached as lic  # noqa: E402
