...
cells as labels, there may be times when we want all text cells in the
path to be considered as labels. For example, “USA” in this wide-format
time series acts like a secondary label because it is an identifier for
