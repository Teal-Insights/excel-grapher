...
In an exported model, the generated setter is imported and called like any other package function. Each record must include a `value` key and each key field (`TIME_PERIOD` here):
