...
the graph to `2`, it will still be `2` in subsequent computations using
the graph (see [Graph evaluation](codegen_basics.md) for more examples,
and [Series bindings](series_bindings.md) for standalone package
export).
