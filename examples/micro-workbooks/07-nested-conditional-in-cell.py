...
if __name__ == "__main__":
    ...
    WORKBOOK_PATH: Path = Path("examples/micro-workbooks/07-nested-conditional-in-cell.xlsx")
    ...
    with open("examples/micro-workbooks/07-nested-conditional-in-cell.qmd", "w") as f:
        f.write(f"```{{dot}}\n{dot}\n```")
