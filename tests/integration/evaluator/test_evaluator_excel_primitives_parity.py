"""Excel primitives: evaluator and generated export runtime agree on small synthetic graphs (integration).

Focused regressions for operators and coercions that often diverge between the
evaluator and transpiled runtime; complements workbook-heavy parity elsewhere.
"""
