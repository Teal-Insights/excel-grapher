"""LIC-DSF constraint diagnosis helpers behave on representative trace inputs (integration).

Exercises ``diagnose_constraint_candidates`` selection, tracing, and formatting helpers
used when analysts triage dynamic-ref constraint coverage in the example pipeline.
"""
...
# ---------------------------------------------------------------------------
from examples.lic_dsf.diagnose_constraint_candidates import (
    TargetEntry,
    TraceCollector,
    TraceEvent,
    _format_seconds,
