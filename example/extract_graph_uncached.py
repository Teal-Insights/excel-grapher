...
def cells_in_range(sheet: str, range_a1: str) -> list[str]:
    ...
    start_col_idx = column_index_from_string(c1)
    end_col_idx = column_index_from_string(c2)
...
def _apply_lic_dsf_workbook_leaf_overlays(constraints: type[Any]) -> None:
    ...
    try:
        ...
        add_range_with_formula_alias(
            _c4, _c4_formula_alias, "E34", Literal["Bullet (1) or Amort. (>1)"]
        )
        ...
        add_cell_with_formula_alias(
            _c4, _c4_formula_alias, "AB22", Annotated[float, RealBetween(0, 100)]
        )
        add_cell_with_formula_alias(
            _c4, _c4_formula_alias, "AB23", Annotated[float, RealBetween(0, 1)]
        )
        add_cell_with_formula_alias(
            _c4, _c4_formula_alias, "AB24", Annotated[float, RealBetween(0, 2000)]
        )
        add_cell_with_formula_alias(_c4, _c4_formula_alias, "AB25", Annotated[int, Between(1, 50)])
        add_cell_with_formula_alias(
            _c4, _c4_formula_alias, "AB26", Annotated[float, RealBetween(0, 1)]
        )
        add_cell_with_formula_alias(
            _c4, _c4_formula_alias, "AB27", Annotated[float, RealBetween(0, 1)]
        )
...
_BLEND_O_CONSTRAINT_KEY = re.compile(r"^'BLEND floating calculations WB'!O(10|[1-3][0-9])$")
_MARKET_FINANCING_INDIRECT_MIRROR_KEY = re.compile(r"^Market_financing![EFG](4[89]|5[0-3])$")
