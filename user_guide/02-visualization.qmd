...
payload = to_semantic_viz_payload(g, bindings, workbook="model.xlsx")
...
On the Q-CRAFT extraction-pipeline workbook (`Teal-Insights/qcraft-extraction-pipeline`, 260,027 bound cells / 489,651 graph edges), catalog analysis plus the statement quotient finished in about 16s and emitted 715 statements / 5,725 bundles (no unbound remainder). That is the heavy-duty check for this overlay; do not vendor that private workbook into excel-grapher.
