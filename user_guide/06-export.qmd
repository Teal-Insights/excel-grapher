...
`original_graph` plus a serializable `manifest` with removed-to-replacement aliases,
formula rewrites, and collapsed-group lineage. Visualization can use the same facade:
