...
**Hands-on walkthrough:** [Series bindings example](https://teal-insights.github.io/excel-grapher/examples/micro-workbooks/series-bindings.html)
([source](https://github.com/Teal-Insights/excel-grapher/blob/main/examples/micro_workbooks/series_bindings.qmd))
...
5. **Export** with `CodeGenerator(..., series_bindings=..., bindings_workbook=...)` to emit `set_*` / `compute_*` functions (see [Code export](06-export.qmd)).
